...
// Standard look: default tiles (no custom renderer), thin white borders.
...
const CHAIN_COLORS: Record<string, string> = {
  ...
  MATIC: "#7c3aed",
  POL: "#7c3aed",
  // Binance (BNB/BSC share the same color)
  BNB: "#f59e0b",
  BSC: "#f59e0b",
  AVAX: "#ef4444",
  SOL: "#9333ea",
        ...
        {!err && data && data.length > 0 && (
          <ResponsiveContainer width="100%" height="100%">
            <Treemap
              ...
              aspectRatio={16 / 9}
              stroke="#ffffff"
              // default strokeWidth (≈1) = “normal” borders between tiles
              isAnimationActive
            >
              <Tooltip
