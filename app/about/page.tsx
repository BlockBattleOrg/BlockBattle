  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-10">
      ...
      <p className="mb-4 text-gray-700">
        ...
        totals and rank the Top 15 currencies by their USD-equivalent contributions.
      </p>
      ...
      <h2 className="mb-2 mt-8 text-xl font-semibold">Roadmap (high level)</h2>
      <ol className="list-decimal pl-6 text-gray-700">
        <li>Phase 1 — Minimal skeleton + deploy ✅</li>
        <li>Phase 2 — UI polish: hero, leaderboard mock, countdown, treemap placeholder, static pages (this page) ✅</li>
        <li>Phase 3 — Live data (DB schema, indexers, FX rates), real treemap & leaderboard</li>
      </ol>
    </main>
  );
}
