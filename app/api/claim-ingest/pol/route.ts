...
// Polygon claim-ingest, chain='pol' (same pattern as ETH)
...
const POL_RPC_URL = process.env.POL_RPC_URL || process.env.EVM_RPC_URL || 'https://matic.nownodes.io';
...
async function rpc(method: string, params: any[]) {
  if (!POL_RPC_URL) return { ok: false as const, error: 'missing_rpc_url' };
